...
- [ ] **AUTH-REG-001**: Реєстрація через Upwork OAuth
- [ ] **AUTH-REG-002**: Валідація email та даних
- [ ] **AUTH-REG-003**: Автоматична синхронізація профілю
- [ ] **AUTH-REG-004**: Створення базового акаунту
- [ ] **AUTH-REG-005**: Відправка підтвердження email

### Вхід користувачів
- [ ] **AUTH-LOGIN-001**: OAuth 2.0 flow з Upwork
- [ ] **AUTH-LOGIN-002**: Генерація JWT токенів
- [ ] **AUTH-LOGIN-003**: MFA верифікація
- [ ] **AUTH-LOGIN-004**: Rate limiting для невдалих спроб
- [ ] **AUTH-LOGIN-005**: Запоминание пристрою
