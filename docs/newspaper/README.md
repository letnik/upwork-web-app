...
- **Приклади**: frontend_completion_report, testing_progress_report
- **Шаблон**: `назва_work_report_vX.Y.Z.md`
...
- **Приклади**: security_audit_report, performance_analysis_report, ai_experiment_test
...
**Всі звіти мають слідувати стандартному формату та зберігатися в відповідних папках з лейблами в назві!** 📰
